...
const mainScrollerStore = create<MainScrollerStore>((set) => ({
  ...
  setMainScrollerDistance: (distance) => set({ mainScrollerDistance: distance }),
}));

export const useSetMainScroller = () => {
  const setMainScrollerDistance = mainScrollerStore((state) => state.setMainScrollerDistance);
...
export const useMainScrollerDistance = () => mainScrollerStore((state) => state.mainScrollerDistance);
